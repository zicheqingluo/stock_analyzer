...
# 导入核心模块
try:
    from quant_strategy_core import (
        load_strategies, save_strategies, view_current_strategies,
        delete_strategy, rename_strategy, get_strategy_details
    )
except ImportError:
    # 如果导入失败，定义简化版本
...
# 导入模式工具模块
try:
    from quant_pattern_utils import (
        extract_stock_symbols_from_text,
